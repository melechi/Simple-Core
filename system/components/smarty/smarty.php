 ...
 * @package Smarty
 */
class component_smarty extends component
{
	const EXCEPTION_NAME='Smarty Exception';
	...
	public function initiate()
	{
		...
		$this->xInclude('compiler');
//		include_once(dirname(__FILE__)._.'libs'._.'Smarty.class.php');
//		$this->smarty=new Smarty;
	}
	
//	public function __call($function,$args)
//	{
//		return call_user_func_array(array($this->smarty,$function),$args);
//	}
//	
...
//		}
		...
		$smarty_compiler=new $this->compiler_class($this);
