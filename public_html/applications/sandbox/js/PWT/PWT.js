...
//	basePath:	'',
	...
	init:			function()
	{
		if (Object.isDefined(Ext) && Object.isDefined(Function.prototype.createDelegate))
		{
//			Function.prototype.createDelegate=Function.prototype.bind;
			Ext.ListView.Sorter.prototype.initEvents=function(view)
			{
	...
	Class:
	{
		...
		create: function(definition)
		{
			...
			namespace[className]=function()
			{
				...
				if (Object.isDefined(namespace[className].prototype.__behaviors) && namespace[className].prototype.__behaviors.length)
				{
				...
				{
					var doNextExtend=function(scope,object,$parent,extension)
					{
						//Save the old $parent in a temp var.
						var tmp=scope[object].$parent;
						//Now override this method with a new one.
						//- This is does so that IF this method calls ITS parent method, it won't recusively call the same method.
							...
							return function()
							{
								if (!Object.isUndefined(extension.definition.$extends))
								{
									...
									while (1)
									{
										...
										{
											gotExtension=true;
											var ret=doNextExtend(scope,object,$parent,ext);
											break;
										}
								...
								if (!gotExtension)
								{
									var ret=$parent.apply(scope,arguments);
								}
								return ret;
							}
				...
				if (Object.isDefined(namespace[className].definition) && Object.isDefined(namespace[className].definition.$extends))
				{
		...
		include: function(filePath,type,callback)
		{
			...
			if (type=='js')
			{
				...
				(
					function(script)
					{
						if (script.src.replace('app:/','')==filePath)
						{
